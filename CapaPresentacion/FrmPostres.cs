...
namespace CapaPresentacion
{
    ...
    public partial class FrmPostres : Form
    {
        ...
        public FrmPostres()
        {
            ...
            this.Load += new System.EventHandler(this.FrmPostres_miLoad);
            this.tabControl1.Selected += new System.Windows.Forms.TabControlEventHandler(this.tabControl1_Selected);
            this.txtBuscar.TextChanged += new System.EventHandler(this.txtBuscar_TextChanged);
            this.ttMensaje.SetToolTip(txtIdpostre, "Ingrese el Valor de Idpostre");
            this.ttMensaje.SetToolTip(txtNombre, "Ingrese el Valor de Nombre");
            this.ttMensaje.SetToolTip(txtPrecio, "Ingrese el Valor de Precio");
            this.ttMensaje.SetToolTip(txtStock, "Ingrese el Valor de Stock");
            this.txtIdpostre.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Control_KeyPress_Idpostre);
            this.txtNombre.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Control_KeyPress_Nombre);
            this.txtPrecio.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Control_KeyPress_Precio);
            this.txtStock.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Control_KeyPress_Stock);
        }
        //--------------------------------------------------------------------------------------------------	
        ...
        private void Control_KeyPress_Precio(object sender, KeyPressEventArgs e)
        {
            ...
            string cadena = this.txtPrecio.Text;
        ...
        private void mostrar()
        {
            ...
            this.tomaTab();
            this.Botones(true);
            this.dataListado.DataSource = NPostres.Mostrar();
        ...
        private void CargaDatos()
        {
            ...
            this.txtIdpostre.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtNombre.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            this.txtPrecio.Text = Convert.ToString(this.ObtenerSeleccion().Cells[3].Value);
            this.txtStock.Text = Convert.ToString(this.ObtenerSeleccion().Cells[4].Value);
        }
        private bool validaCampos()
        {
            if (this.txtIdpostre.Text == string.Empty)
            {
                errorIcono.SetError(txtIdpostre, "Ingrese el dato por Favor..");
            ...
            {
                errorIcono.SetError(txtNombre, "Ingrese el dato por Favor..");
            ...
            {
                errorIcono.SetError(txtPrecio, "Ingrese el dato por Favor..");
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NPostres.Insertar(this.txtIdpostre.Text, this.txtNombre.Text, this.txtPrecio.Text, this.txtStock.Text);
        ...
        private void ActualizaRegistro()
        {
            ...
            try
            {
                Rta = NPostres.Editar(this.txtIdpostre.Text, this.txtNombre.Text, this.txtPrecio.Text, this.txtStock.Text);
                if (Rta.Equals("OK"))
                {
        ...
        private void buscarNombre()
        {
            ...
            {
                this.dataListado.DataSource = NPostres.BuscarNombre(this.txtBuscar.Text);
