...
{
    public partial class FrmbdiSOCpSociedades : KryptonForm
{
        ...
        private static FrmbdiSOCpSociedades _Instancia;

        public static FrmbdiSOCpSociedades GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmbdiSOCpSociedades();
            }
            return _Instancia;
        }
        public FrmbdiSOCpSociedades()
        {
            InitializeComponent();
       ...
       //  --------------------------------------------------------------------
        ...
        {
            this.txtBUKRS.Text = "0";
            this.txtBUTXT.Text = string.Empty;
        ...
        private void CargaDatos()
        {
            ...
            this.txtBUKRS.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtBUTXT.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            
        }
        private bool validaCampos()
        {
            if (this.txtBUKRS.Text == string.Empty)
            {
                errorIcono.SetError(txtBUKRS, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtBUKRS.Focus();
                return false;
            }
            if (this.txtBUTXT.Text == string.Empty)
            {
                errorIcono.SetError(txtBUTXT, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtBUTXT.Focus();
                return false;
            }
        ...
        //-------------------------------------------------------------------
        private void FrmbdiSOCpSociedades_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }

        private void FrmbdiSOCpSociedades_Load(object sender, EventArgs e)
        {
