...
{
    public partial class FrmacfMATt_Material : KryptonForm
{
        ...
        private static FrmacfMATt_Material _Instancia;

        public static FrmacfMATt_Material GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfMATt_Material();
            }
            return _Instancia;
        }
        public FrmacfMATt_Material()
        {
            InitializeComponent();
            ...
            this.Load += new System.EventHandler(this.FrmacfMATt_Material_miLoad);
            this.tabControl1.Selected += new System.Windows.Forms.TabControlEventHandler(this.tabControl1_Selected);
            this.txtBuscar.TextChanged += new System.EventHandler(this.txtBuscar_TextChanged);
            this.ttMensaje.SetToolTip(txtMATid, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtMATmaterial, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtMATabreviado, "Ingrese el valor");
       ...
       //  --------------------------------------------------------------------
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[1].HeaderText = "MATid";
            this.dataListado.Columns[2].HeaderText = "MATmaterial";
            this.dataListado.Columns[3].HeaderText = "MATabreaviado";
        }
        ...
        private void mostrar()
        {
            ...
            this.tomaTab();
            this.Botones(true);
            this.dataListado.DataSource = NacfMATt_Material.Mostrar();
        ...
        {
            this.txtMATid.Text = "0";
            this.txtMATmaterial.Text = string.Empty;
            this.txtMATabreviado.Text = string.Empty;
        }
        ...
        private void CargaDatos()
        {
            ...
            this.txtMATid.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtMATmaterial.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            this.txtMATabreviado.Text = Convert.ToString(this.ObtenerSeleccion().Cells[3].Value);
        }
        private bool validaCampos()
        {
            if (this.txtMATid.Text == string.Empty)
            {
                errorIcono.SetError(txtMATid, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtMATid.Focus();
                return false;
            }
            if (this.txtMATmaterial.Text == string.Empty)
            {
                errorIcono.SetError(txtMATmaterial, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtMATmaterial.Focus();
                return false;
            }
            if (this.txtMATabreviado.Text == string.Empty)
            {
                errorIcono.SetError(txtMATabreviado, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtMATabreviado.Focus();
                return false;
            }
            return true;
        }
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NacfMATt_Material.Insertar(
                    this.txtMATid.Text, 
                    this.txtMATmaterial.Text,
                    this.txtMATabreviado.Text);

                if (Rta.Equals("OK"))
                {
                    this.MensajeOk("RegiStro Acgregado Correctamente");
                }
                else
                {
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfMATt_Material.Eliminar(Codigo);
        ...
        private void buscarNombre()
        {
            ...
            {
                this.dataListado.DataSource = NacfMATt_Material.Buscar(this.txtBuscar.Text);
        ...
        private void Configura()
        {
            ...
            this.txtMATid.TextAlign = HorizontalAlignment.Right;
            this.txtMATmaterial.TabIndex = 2;
        ...
        //-------------------------------------------------------------------
        private void FrmacfMATt_Material_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }

        private void FrmacfMATt_Material_Load(object sender, EventArgs e)
        {
