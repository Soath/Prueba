    ...
    public partial class FrmacfAMBt_Ambiente : KryptonForm
{
        ...
        private static FrmacfAMBt_Ambiente _Instancia;

        public static FrmacfAMBt_Ambiente GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfAMBt_Ambiente();
            }
            return _Instancia;
        }
        public FrmacfAMBt_Ambiente()
        {
            InitializeComponent();
            ...
            this.Load += new System.EventHandler(this.FrmacfAMBt_Ambiente_miLoad);
            this.tabControl1.Selected += new System.Windows.Forms.TabControlEventHandler(this.tabControl1_Selected);
            this.txtBuscar.TextChanged += new System.EventHandler(this.txtBuscar_TextChanged);
            this.ttMensaje.SetToolTip(txtAMBid, "Ingrese el Valor ");
            this.ttMensaje.SetToolTip(txtLOCid, "Ingrese el Valor ");
            this.ttMensaje.SetToolTip(txtAMBambiente, "Ingrese el Valor ");
        }
        //--------------------------------------------------------------------------------------------------	
       ...
       //  --------------------------------------------------------------------
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[3].HeaderText = "Descripcion de Ambiente";
        }
        ...
        private void mostrar()
        {
            ...
            this.tomaTab();
            this.Botones(true);
            this.dataListado.DataSource = NacfAMBt_Ambiente.Mostrar();
            OcultarColumnas();
        ...
        {
            FrmReportes rptalu = new FrmReportes("Reportes\\Rpt_AMBAmbiente.rdlc", NacfAMBt_Ambiente.Mostrar(),"ip");
            rptalu.ShowDialog();
        }
        ...
        {
            this.txtAMBid.Text = "0";
            this.txtLOCid.Text = string.Empty;
            this.txtAMBambiente.Text = string.Empty;
        ...
        private void CargaDatos()
        {
            ...
            this.txtAMBid.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtLOCid.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            this.txtAMBambiente.Text = Convert.ToString(this.ObtenerSeleccion().Cells[3].Value);
            //this.txtStock.Text = Convert.ToString(this.ObtenerSeleccion().Cells[4].Value);
        }
        private bool validaCampos()
        {
            if (this.txtAMBid.Text == string.Empty)
            {
                errorIcono.SetError(txtAMBid, "Ingrese el dato por Favor..");
            ...
            if (this.txtAMBambiente.Text == string.Empty)
            {
                errorIcono.SetError(txtAMBambiente, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtAMBambiente.Focus();
                return false;
            }
            return true;
        }
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NacfAMBt_Ambiente.Insertar(this.txtAMBid.Text, this.txtLOCid.Text, this.txtAMBambiente.Text);
        ...
        private void ActualizaRegistro()
        {
            ...
            try
            {
                Rta = NacfAMBt_Ambiente.Editar(this.txtAMBid.Text, this.txtLOCid.Text, this.txtAMBambiente.Text);
                if (Rta.Equals("OK"))
                {
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfAMBt_Ambiente.Eliminar(Codigo);
        ...
        private void Configura()
        {
            ...
            this.txtAMBid.TabIndex = 1;
            this.txtAMBid.TextAlign = HorizontalAlignment.Right;
        ...
        //-------------------------------------------------------------------
        private void FrmacfAMBt_Ambiente_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }
