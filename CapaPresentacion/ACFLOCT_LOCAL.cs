...
{
    public partial class ACFLOCT_LOCAL : UserControl
    {
        int numeroPagina = 1;
        int registrosPorPagina = 25;
        int cantidadPaginas;

        public ACFLOCT_LOCAL()
        {
            InitializeComponent();
            Mostrar();
        }
        ...
        private void buttonEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    FrmEditarLocal editarCategoria = new FrmEditarLocal(this);
        ...
        {
            FrmAgregarNuevLocal nuevoCategoria = new FrmAgregarNuevLocal(this);
