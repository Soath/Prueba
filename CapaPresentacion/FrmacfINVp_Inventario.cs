...
{
    public partial class FrmacfINVp_Inventario : Form
    {
        ...
        private static FrmacfINVp_Inventario _Instancia;

        public static FrmacfINVp_Inventario GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfINVp_Inventario();
            }
            return _Instancia;
        }
        public FrmacfINVp_Inventario()
        {
            InitializeComponent();
            ...
            this.Load += new System.EventHandler(this.FrmacfINVp_Inventario_miLoad);
        ...
        {
            FrmReportes rptalu = new FrmReportes("Reportes\\Rpt_INVInventario.rdlc", NacfINVp_Inventario.Mostrar(),"ip");
            rptalu.ShowDialog();
        }
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NacfINVp_Inventario.Insertar(this.txtINVid.Text, this.txtINVdetalle.Text, this.txtINVinicio.Text, this.txtINVcierre.Text, this.txtINVactivo.Text);
        ...
        private void ActualizaRegistro()
        {
            ...
            try
            {
                Rta = NacfINVp_Inventario.Editar(this.txtINVid.Text, this.txtINVdetalle.Text, this.txtINVinicio.Text,this.txtINVcierre.Text,this.txtINVactivo.Text);
                if (Rta.Equals("OK"))
                {
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfINVp_Inventario.Eliminar(Codigo);
        ...
        private void buscarNombre()
        {
            ...
            {
                this.dataListado.DataSource = NacfINVp_Inventario.Buscar(this.txtBuscar.Text);
        ...
        //-------------------------------------------------------------------
        private void FrmacfINVp_Inventario_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }

        private void FrmacfINVp_Inventario_Load(object sender, EventArgs e)
        {
