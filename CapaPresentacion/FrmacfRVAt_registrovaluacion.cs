...
{
    public partial class FrmacfRVAt_registrovaluacion : KryptonForm
{
        ...
        private static FrmacfRVAt_registrovaluacion _Instancia;

        public static FrmacfRVAt_registrovaluacion GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfRVAt_registrovaluacion();
            }
            return _Instancia;
        }
        public FrmacfRVAt_registrovaluacion()
        {
            InitializeComponent();
            ...
            this.Load += new System.EventHandler(this.FrmacfRVAt_registrovaluacion_miLoad);
            this.tabControl1.Selected += new System.Windows.Forms.TabControlEventHandler(this.tabControl1_Selected);
            this.txtBuscar.TextChanged += new System.EventHandler(this.txtBuscar_TextChanged);
            this.ttMensaje.SetToolTip(txtRVAcodigo, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtRVAperiodo, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtRVAfecha, "Ingrese el valor");
            this.ttMensaje.SetToolTip(txtRVAresponsable, "Ingrese el valor");
            this.ttMensaje.SetToolTip(txtRVestado, "Ingrese el valor");
        }
        //--------------------------------------------------------------------------------------------------	
       ...
       //  --------------------------------------------------------------------
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[1].HeaderText = "RVAcodigo";
            this.dataListado.Columns[2].HeaderText = "RVAperiodo";
            this.dataListado.Columns[3].HeaderText = "RVAfecha";
            this.dataListado.Columns[4].HeaderText = "RVAresponsable";
            this.dataListado.Columns[5].HeaderText = "RVestado";
        }
        ...
        private void mostrar()
        {
            ...
            this.tomaTab();
            this.Botones(true);
            this.dataListado.DataSource = NacfRVAt_registrovaluacion.Mostrar();
        ...
        {
            this.txtRVAcodigo.Text = "0";
            this.txtRVAperiodo.Text = string.Empty;
            this.txtRVAfecha.Text = string.Empty;
            this.txtRVAresponsable.Text = string.Empty;
            this.txtRVestado.Text = string.Empty;
        }
        ...
        private void CargaDatos()
        {
            ...
            this.txtRVAcodigo.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtRVAperiodo.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            this.txtRVAfecha.Text = Convert.ToString(this.ObtenerSeleccion().Cells[3].Value);
            this.txtRVAresponsable.Text = Convert.ToString(this.ObtenerSeleccion().Cells[4].Value);
            this.txtRVestado.Text = Convert.ToString(this.ObtenerSeleccion().Cells[5].Value);
        }
        private bool validaCampos()
        {
            if (this.txtRVAcodigo.Text == string.Empty)
            {
                errorIcono.SetError(txtRVAcodigo, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtRVAcodigo.Focus();
                return false;
            }
            if (this.txtRVAperiodo.Text == string.Empty)
            {
                errorIcono.SetError(txtRVAperiodo, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtRVAperiodo.Focus();
                return false;
            }
            if (this.txtRVAfecha.Text == string.Empty)
            {
                errorIcono.SetError(txtRVAfecha, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtRVAfecha.Focus();
                return false;
            }
            if (this.txtRVAresponsable.Text == string.Empty)
            {
                errorIcono.SetError(txtRVAresponsable, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Stock";
                this.txtRVAresponsable.Focus();
                return false;
            }
            if (this.txtRVestado.Text == string.Empty)
            {
                errorIcono.SetError(txtRVestado, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Stock";
                this.txtRVestado.Focus();
                return false;
            }
            return true;
        }
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NacfRVAt_registrovaluacion.Insertar(
                    ...
                    this.txtRVAfecha.Text,
                    this.txtRVAresponsable.Text,
                    this.txtRVestado.Text);
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfRVAt_registrovaluacion.Eliminar(Codigo);
        ...
        private void buscarNombre()
        {
            ...
            {
                this.dataListado.DataSource = NacfRVAt_registrovaluacion.Buscar(this.txtBuscar.Text);
        ...
        //-------------------------------------------------------------------
        private void FrmacfRVAt_registrovaluacion_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }
