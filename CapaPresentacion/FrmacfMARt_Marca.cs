...
{
    public partial class FrmacfMARt_Marca : KryptonForm
    {
        ...
        private static FrmacfMARt_Marca _Instancia;

        public static FrmacfMARt_Marca GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfMARt_Marca();
            }
            return _Instancia;
        }
        public FrmacfMARt_Marca()
        {
            InitializeComponent();
        ...
        {
            this.txtMARid.Text = "0";
            this.txtMARmarca.Text = string.Empty;
        ...
        private void CargaDatos()
        {
            ...
            this.txtMARid.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtMARmarca.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
         

        }
        private bool validaCampos()
        {
            if (this.txtMARid.Text == string.Empty)
            {
                errorIcono.SetError(txtMARid, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el codigo de marca";
                this.txtMARid.Focus();
                return false;
            }
            if (this.txtMARmarca.Text == string.Empty)
            {
                errorIcono.SetError(txtMARmarca, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar la Descripción de marca";
                this.txtMARmarca.Focus();
                return false;
            }
        ...
        private void InsertaRegistro()
        {
            ...
            try
            {
                Rta = NacfMARt_Marca.Insertar(this.txtMARid.Text, this.txtMARmarca.Text);
        ...
        private void ActualizaRegistro()
        {
            ...
            try
            {
                Rta = NacfMARt_Marca.Editar(this.txtMARid.Text, this.txtMARmarca.Text);
                if (Rta.Equals("OK"))
                {
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfMARt_Marca.Eliminar(Codigo);
        ...
        //-------------------------------------------------------------------
        private void FrmacfMARt_Marca_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }

        private void FrmacfMARt_Marca_Load(object sender, EventArgs e)
        {
