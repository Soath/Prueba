...
{
    public partial class FrmacfPDFt_procesodiferido : KryptonForm
{
        ...
        private static FrmacfPDFt_procesodiferido _Instancia;

        public static FrmacfPDFt_procesodiferido GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfPDFt_procesodiferido();
            }
            return _Instancia;
        }
        public FrmacfPDFt_procesodiferido()
        {
            InitializeComponent();
            ...
            this.Load += new System.EventHandler(this.FrmacfPDFt_procesodiferido_miLoad);
            this.tabControl1.Selected += new System.Windows.Forms.TabControlEventHandler(this.tabControl1_Selected);
            this.txtBuscar.TextChanged += new System.EventHandler(this.txtBuscar_TextChanged);
            this.ttMensaje.SetToolTip(txtPDFcodigo, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtPDFperiodo, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(dtpPDFfecha, "Ingrese el valor");
            this.ttMensaje.SetToolTip(txtPDFresponsable, "Ingrese el valor");
            this.ttMensaje.SetToolTip(txtPDFestado, "Ingrese el valor");
        }
        //--------------------------------------------------------------------------------------------------	
       ...
       //  --------------------------------------------------------------------
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[1].HeaderText = "PDFcodigo";
            this.dataListado.Columns[2].HeaderText = "PDFperiodo";
            this.dataListado.Columns[3].HeaderText = "PDFfecha";
            this.dataListado.Columns[4].HeaderText = "PDFresponsable";
            this.dataListado.Columns[5].HeaderText = "PDFestado";
        }
        ...
        {
            this.txtPDFcodigo.Text = "0";
            this.txtPDFperiodo.Text = string.Empty;
            this.dtpPDFfecha.Text = string.Empty;
            this.txtPDFresponsable.Text = string.Empty;
            this.txtPDFestado.Text = string.Empty;
        }
        ...
        private void CargaDatos()
        {
            ...
            this.txtPDFcodigo.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtPDFperiodo.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            this.dtpPDFfecha.Text = Convert.ToString(this.ObtenerSeleccion().Cells[3].Value);
            this.txtPDFresponsable.Text = Convert.ToString(this.ObtenerSeleccion().Cells[4].Value);
            this.txtPDFestado.Text = Convert.ToString(this.ObtenerSeleccion().Cells[5].Value);
        }
        private bool validaCampos()
        {
            if (this.txtPDFcodigo.Text == string.Empty)
            {
                errorIcono.SetError(txtPDFcodigo, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Idpostre";
                this.txtPDFcodigo.Focus();
                return false;
            }
            if (this.txtPDFperiodo.Text == string.Empty)
            {
                errorIcono.SetError(txtPDFperiodo, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Nombre";
                this.txtPDFperiodo.Focus();
                return false;
            }
            if (this.dtpPDFfecha.Text == string.Empty)
            {
                errorIcono.SetError(dtpPDFfecha, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Precio";
                this.dtpPDFfecha.Focus();
                return false;
            }
            if (this.txtPDFresponsable.Text == string.Empty)
            {
                errorIcono.SetError(txtPDFresponsable, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Stock";
                this.txtPDFresponsable.Focus();
                return false;
            }
            if (this.txtPDFestado.Text == string.Empty)
            {
                errorIcono.SetError(txtPDFestado, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor de Stock";
                this.txtPDFestado.Focus();
                return false;
            }
            return true;
        }
        ...
        private void borrauno()
        {
            ...
            if (Opcion == DialogResult.OK)
            {
                ...
                Rta = NacfPDFt_procesodiferido.Eliminar(Codigo);
        ...
        private void buscarNombre()
        {
            ...
            {
                this.dataListado.DataSource = NacfPDFt_procesodiferido.Buscar(this.txtBuscar.Text);
        ...
        //-------------------------------------------------------------------
        private void FrmacfPDFt_procesodiferido_miLoad(object sender, EventArgs e)
        {
            this.mostrar();
        }
