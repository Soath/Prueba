    ...
    public partial class FrmacfCSTt_Costo : KryptonForm
{
       ...
       //  --------------------------------------------------------------------
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[1].HeaderText = "CSTid";
            this.dataListado.Columns[2].HeaderText = "CSTdescripcion";
            this.dataListado.Columns[3].HeaderText = "CSTdetalle";
            this.dataListado.Columns[4].HeaderText = "CSTabreviado";
            this.dataListado.Columns[5].HeaderText = "ACTid";
            this.dataListado.Columns[6].HeaderText = "CSTid_costo";
        }
        ...
        {
            FrmReportes rptalu = new FrmReportes("Reportes\\Rpt_CSTCosto.rdlc", NacfCSTt_Costo.Mostrar());
            rptalu.ShowDialog();
        }
