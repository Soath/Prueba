...
{
    public partial class FrmacfESTt_Estado : KryptonForm
{
        ...
        private static FrmacfESTt_Estado _Instancia;

        public static FrmacfESTt_Estado GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FrmacfESTt_Estado();
            }
            return _Instancia;
        }
        public FrmacfESTt_Estado()
        {
            InitializeComponent();
            ...
            this.ttMensaje.SetToolTip(txtESTid, "Ingrese el Valor");
            this.ttMensaje.SetToolTip(txtESTestado, "Ingrese el Valor");          
       ...
       //  --------------------------------------------------------------------
        ...
        {
            this.txtESTid.Text = "0";
            this.txtESTestado.Text = string.Empty;
        ...
        private void CargaDatos()
        {
            ...
            this.txtESTid.Text = Convert.ToString(this.ObtenerSeleccion().Cells[1].Value);
            this.txtESTestado.Text = Convert.ToString(this.ObtenerSeleccion().Cells[2].Value);
            
        }
        private bool validaCampos()
        {
            if (this.txtESTid.Text == string.Empty)
            {
                errorIcono.SetError(txtESTid, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtESTid.Focus();
                return false;
            }
            if (this.txtESTestado.Text == string.Empty)
            {
                errorIcono.SetError(txtESTestado, "Ingrese el dato por Favor..");
                this.MensError = "Falta ingresar el valor";
                this.txtESTestado.Focus();
                return false;
            }
        ...
        private void FrmacfESTt_Estado_Load(object sender, EventArgs e)
        {
