    ...
    public string CerrarInventario(DacfICRt_Inventariocaracteristicas acfICRt_Inventariocaracteristicas)
        {
            ...
            try
            {
                ...
                {
                    ParCRScantidad.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRScantidad);
                }
                SqlCmd.Parameters.Add(ParCRScantidad);
                //
                SqlParameter ParCRSvehplaca = new SqlParameter();
                ...
                {
                    ParCRSvehpesoseco.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSvehpesoseco);
                }
                SqlCmd.Parameters.Add(ParCRSvehpesoseco);
                //
                SqlParameter ParCRSvehcargautil = new SqlParameter();
                ...
                {
                    ParCRSvehcargautil.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSvehcargautil);
                }
                SqlCmd.Parameters.Add(ParCRSvehcargautil);
                //
                SqlParameter ParCRSaltura = new SqlParameter();
                ...
                {
                    ParCRSaltura.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSaltura);
                }
                SqlCmd.Parameters.Add(ParCRSaltura);
                ...
                {
                    ParCRSancho.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSancho);
                }
                SqlCmd.Parameters.Add(ParCRSancho);
                ...
                {
                    ParCRSareaconstruida.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSareaconstruida);
                }
                SqlCmd.Parameters.Add(ParCRSareaconstruida);
                //
                SqlParameter ParCRSperimetro = new SqlParameter();
                ...
                {
                    ParCRSperimetro.Value = Convert.ToInt64(acfICRt_Inventariocaracteristicas.CRSperimetro);
                }
                SqlCmd.Parameters.Add(ParCRSperimetro);
                //
                SqlParameter ParCRSusopredio = new SqlParameter();
